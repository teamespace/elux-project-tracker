  ...
  <Teleport to="body">
    ...
    >
      <div
        ...
        :class="[
          view === 'center'
            ? 'left-1/2 top-1/2 h-[85vh] w-full max-w-[600px] -translate-x-1/2 -translate-y-1/2'
      ...
      >
        ...
        <div class="flex shrink-0 items-center justify-between gap-2 border-b border-gray-100 px-4 py-2.5">
          <div ref="menuRef" class="relative flex items-center gap-1">
            <UButton
              variant="ghost" color="neutral" size="xs" square
              icon="ph:arrows-out" title="Expand to center"
              @click="setView('center')"
            />
            <div class="h-4 w-px bg-gray-200" />
            <UButton
              variant="ghost" color="neutral" size="xs" square
              icon="ph:layout" title="Change view"
