...
const { state, close } = useProjectLinkSlideOver()

defineEmits<{ link: [project: import('~/shared/projects').Project] }>()
    ...
    >
      ...
      >
        ...
        <div class="flex-1 overflow-hidden">
          <ProjectLinkContent @link="$emit('link', $event); close()" @close="close" />
        </div>
      </div>
    </Transition>
  </Teleport>
